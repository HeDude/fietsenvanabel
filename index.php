        ...
        <section class="row tm-section">
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
                <div class="tm-flex-center p-5 tm-bg-color-primary tm-section-min-h">
                    <h1 class="tm-text-color-white tm-site-name">Fietsen van Abel</h1>
                </div>
            </div>
                ...
                <div class="tm-flex-center">
                    <div class="tm-pricing-table">
                        <div class="tm-bg-color-secondary tm-text-color-white text-center tm-font-thin tm-pricing-header">
                            <p class="mb-0 tm-pricing-header-title">Interesse</p>
                            <p class="mb-0 tm-pricing-header-subtitle">Heb je interesse in een geheel eigen fiets, op basis van een bestaand exemplaar, of wil je een paar dingen aan je eigen fiets laten doen? Neem contact op!</p>
                        </div>
                        <div class="tm-pricing-body">
                            <p></p>
                            <a href="mailto:abel@bijbrengen.nl" class="btn btn-secondary">Interesse</a>
                        </div>
                    </div>
                </div>
            </div>
